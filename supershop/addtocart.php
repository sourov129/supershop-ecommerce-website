...
$query=$con->prepare("SELECT * FROM `customercart` WHERE 1");
...
foreach($list as $item){
    echo "
    <div class=\"product-view\">
        <img src=\"$item[4]\" class=\"img-thumbnail\" style=\"height:300px; margin:30px;\" alt=\"\">
        <div class=\"itemdetails\">
        <h2>$item[1]</h2>
        <h1 style=\"font-size: 20px;\">৳ $item[3]</h1>
        <p>Quantity: $item[2]</p></div>
        <div>
        <a href=\"deleteproduct.php?item=$item[0]\"><button type=\"button\" class=\"btn btn-danger mt-5 ms-5\">Cancel</button></a>
        </div>
        </div>
