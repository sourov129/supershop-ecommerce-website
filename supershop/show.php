...
<body>
    ...
    <nav class="navbar bg-body-tertiary p-3">
        ...
        <nav class="navbar navbar-expand-lg mt-5 fw-semibold bg-secondary " data-bs-theme="secondary"">
            <div class="container-fluid">
                ...
                <div class="dropdown">
                    ...
                    <!-- productdetails.php?item=$item[2] -->
      ...
      <section class="container1">
        <div class="bg-image">
            ...
            <div class="heading">
                <h2>Bag Full of produts</h2>

                <p>Frozen & chilled Food<br>Fresh Fruits & Vegatbales</p>
                <a href="#product"><button class="btn-shop">Shop Now</button></a>
    ...
    <div>
    <p class="h2 bg-body-tertiary mt-3 text-center p-3">All Products</p>
    </div>
...
foreach($list as $item){
    echo "
    <div class=\"col-lg-3 shadow p-4  bg-white rounded\" id=\"product\">
